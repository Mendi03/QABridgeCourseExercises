...
public class AccountTest {
    ...
    void testGetClaims() throws ParseException, IOException {
    ...
    void testGetClaimsP() throws ParseException, IOException {
        List<List<String>> claims = new ArrayList<>();
        List<String> claim1 = new ArrayList<>();
        List<String> claim2 = new ArrayList<>();
        List<String> claim3 = new ArrayList<>();
  ...
  //3. As a provider, I should be able to upload several claims at once and add them to the database
    ...
    void testSubmitClaims() throws ParseException, IOException {
        List<List<String>> claims = new ArrayList<>();
        List<String> claim1 = new ArrayList<>();
        List<String> claim2 = new ArrayList<>();
        List<String> claim3 = new ArrayList<>();
        ...
        providerTest.submitClaims(accountTest, claims);
    ...
    @Test
    @DisplayName("Testing whether new accounts have different ID's when created")
    void testID(){
        User user1 = new User();
        User user2 = new User();
